...
type: 
summary: 
description: My Favorite Cyberpunk Mods
sidebar: false
---
...
- **CharLi**: <https://www.nexusmods.com/cyberpunk2077/mods/8176>.  Useful for placing additional lighting when taking screenshots.  I personally use this over Otis' CyberLit Addon.  


## Enhancing Visuals

- **Ultra Plus**: <https://www.nexusmods.com/cyberpunk2077/mods/10490>.  Recommended for fine tuning the game's ray tracing and path tracing options.   The PTNextV3 mode provides the best path tracing experience you can get.  You can view the full list of features here: <https://theultraplace.com/games/cyberpunk2077/>

- **ReLUX**: <https://www.nexusmods.com/cyberpunk2077/mods/20808>. Removes fake light sources throughout the game.  Also adds emissive lights to all the fast travel points.

- **Nova City 2**: <https://www.nexusmods.com/cyberpunk2077/mods/12490>.  Fixes the game's horrible exposure issues.  If you're playing in HDR and are using path tracing, this mod is a life saver just for that.  The added weathers are just a handy bonus feature.

- **LUT Switcher 2**: <https://www.nexusmods.com/cyberpunk2077/mods/16310>.  People love a good LUT mod.  This is the easiest way to apply them.  Can switch between LUTs without having to restart the game.  Requires LUT packs designed for LUT Switcher.

- **Creepy Ultra HDR - ReShade Preset**: <https://www.nexusmods.com/cyberpunk2077/mods/28191>.  Shameless plug. I use the gameplay preset as a baseline for all my shots.  The virtual photography preset was added for people who want a more intense look, but I honestly don't use it when taking screenshots. It was done more for fun of it.
