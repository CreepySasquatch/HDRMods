...
{% include callout.html type="warning" content="Most shaders to not work with HDR.  Quite a few non-HDR shaders will work with HDR10 without too much issue but if you try using them with scRGB you'll definitely run into issues.  A work around is using Soop's HDR Converter shaders." %}

For more info on how to use SDR shaders with HDR check out this guide: [*HDR Shader Order*](HDR-Shader-Order)
